      ...
      <main>
        ...
        <div id="section1">
          ...
          <p>
            ...
            offers driver's ed you can take that class (although it will take
            more time). I recommend using Aceable Driving, and you can buy their
        ...
        <div id="section2">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src={perm_reqs} alt="dmv permit requirements" height="500px" />
          </a>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              mailed after completing your driver's ed course. <br />
              <br />
            </p>
          </section>
          <section>
            ...
            <section>
              ...
              <p>
                ...
                <p>
                  Make sure to smile, I made the mistake of not smiling and now
                  I look like I was taking a mugshot.
                </p>
        ...
        <div id="section3">
          ...
          <p>
            ...
            test. You can practice by actually paying attention during driver's
            ed (jk who even does that (jk again)) and by taking practice tests.
            ...
            <br />
            <br /> The biggest thing you need to remember for the knowledge test
            though is that if you use common sense, you'll likely pass, since
            that's what driving mostly is. Common sense and logic is all you
            need for this test.
            <br />
            <br />
            <br />
        ...
        <div>
          <p>
            ...
            <br />
            <br />
            if you have any questions or comments or changes or anything idk hmu
            <br />
            <br />
            <br />
          </p>
