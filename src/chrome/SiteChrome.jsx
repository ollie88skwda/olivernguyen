  ...
  return (
    <div className="site-chrome">
      ...
      >
        ...
        <nav className="sc-links" aria-label="Primary">
          <a className="sc-link" href="/#work">Work</a>
          <a className="sc-link" href="/#about">About</a>
          <a className="sc-link" href="/#contact">Contact</a>
        </nav>
        <div className="sc-right">
          ...
          <button
            type="button"
            className="sc-cmdk"
            onClick={() => window.dispatchEvent(new CustomEvent("on:cmdk"))}
